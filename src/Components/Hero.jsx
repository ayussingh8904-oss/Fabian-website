...
const Hero = () => {
  ...
  return (
    <>
     <section className='w-full h-200  overflow-hidden bg-[url(https://static.wixstatic.com/media/467b46_9b7981a77b474cdd8d95480cb1b799c4~mv2.jpg/v1/fill/w_1351,h_725,fp_0.61_0.78,q_85,usm_0.66_1.00_0.01,enc_auto/bg.jpg)] bg-no-repeat bg-cover bg-center bg-fixed'>
